...
void Application::update()
{
	...
	Rotacion = glm::rotate(glm::mat4(1.0f), glm::radians(angles.x), glm::vec3(1.5f, 0.0f, 0.0f));
	Rotacion = glm::rotate(Rotacion, glm::radians(angles.y), glm::vec3(0.0f, 1.0f, 0.0f));
	Rotacion = glm::rotate(Rotacion, glm::radians(angles.z), glm::vec3(0.0f, 0.0f, 1.0f));


	transform = glm::translate(glm::mat4(1.0f), glm::vec3(2.0f, 0.0f, 0.0f)) * Rotacion;
	transform = glm::perspective(45.0f, 1024.0f/758.0f , 0.1f, 10.0f) * 
				camera * transform;


	transform2 = glm::translate(glm::mat4(1.0f), glm::vec3(-2.0f, 0.0f, 0.0f)) * Rotacion;
	transform2 = glm::perspective(45.0f, 1024.0f / 758.0f, 0.1f, 10.0f) *
		camera * transform2;
